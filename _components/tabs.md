...
bar as wide as its label, and hovering fills the tab with a flat tint. For
primary section navigation — a project's own tabs, never a filter. This is the
default; no `data-variant` needed.
