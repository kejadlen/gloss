...
A Tooltip wraps whatever it labels — most often an [IconButton]({{ '/components/icon-button/' | relative_url }}), since that is the control with no visible text of its own.

{% example title="On a badge" %}
<span class="ad-tooltip">
