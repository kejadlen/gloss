...
and `.claude-plugin/plugin.json` at the root, wrapping the `SKILL.md` also at
the root (the standard [Agent Skills](https://code.claude.com/docs/en/skills)
format). Install it from anywhere:
